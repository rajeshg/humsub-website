...
import VendorMap from "./images/HD2024_Vendor_Layout_V1-1-1152x1536.jpg";
import ParkingMap from "./images/parking-map-hd-2024.png";
import SustainabilityMap from "./images/HD-2024-sustainability-768x994.jpeg";

Hum Sub is proud to announce the 24th edition of the Hum Sub Diwali festival on October 12, 2024.  Bring your families and friends for a daylong cultural immersion into the Indian subcontinent filled with lots of entertainment, shopping, sumptuous food and breathtaking fireworks.  Please mark your calendars for 10/12 and watch for updates on https://www.humsub.org.
...
Admission: FREE TO THE PUBLIC.  Seating – Seniors (65 and older only with a valid government ID) have access to free seating (limited seats) all day long.  Free seats for everyone upfront until daytime programs end.
...
Seating arrangements: https://humsub.org/wp-content/uploads/2024/10/HD2024-SeatingArrangements-v2.pdf
...
![Vendor Map](./images/HD2024_Vendor_Layout_V1-1-1152x1536.jpg)

### Parking Map

![Parking Map](./images/parking-map-hd-2024.png)

### Sustainability

<Image src={SustainabilityMap} alt="Sustainability" layout="fit" />
